...
$(BUILD)/$(TARGET): $(BUILD)/parser.tab.o $(BUILD)/lex.yy.o $(BUILD)/ast.o $(BUILD)/lex_help.o $(BUILD)/sym.o $(BUILD)/type.o $(BUILD)/main.o $(BUILD)/die-util.o $(BUILD)/quads.o $(BUILD)/assemble.o 
	gcc $(CXXFLAGS) $^ -o $@
